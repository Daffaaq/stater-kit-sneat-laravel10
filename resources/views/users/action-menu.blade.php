    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body d-flex justify-content-around">
                <button type="button" class="btn btn-warning edit-user-btn" id="modal-edit-btn"><i
                        class="bx bx-edit"></i>
                    Edit</button>
                <button type="button" class="btn btn-danger delete-user-btn" id="modal-delete-btn"><i
                        class="bx bx-trash"></i>
                    Delete</button>
            </div>
        </div>
